    ...
    dbc.Container([
        ...
        dbc.Row([
            ...
            dbc.Col(dbc.Card(children=[html.H3(children='Abount Me',
                                             ...
                                             dbc.Col(html.H5(children='I am computer Engineer with 7 years of experience in IT. Currently persueing masters in Data Analysis in DKIT'
                )
